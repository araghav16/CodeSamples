...
class _Element(object):
    """
     Clas to represent a node with a single item and a link to next node.
    """
...
class Queue(object):
    """
        An implementation of queue using linkedlists
    """   
    def __init__(self):
        self.front = None
        self.rear  = None
...
def selfTestStack():
    """ Function to test various methods from Stack class """ 
...
def selfTestQueue():  
    """ Function to test various methods from Queue class """ 
